...
Setting the `size` property allows you to adjust the component size, which also affects the size of the input field.
...
| size                | Slider size                                                                             | string            | medium / small / mini         | small   |
